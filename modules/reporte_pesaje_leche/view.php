...
<section class="content">
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="box box-primary">
        <!-- form start -->
        <form role="form" class="form-horizontal" method="post" action="modules/reporte_pesaje_leche/reporte.php" target="_blank">
          <div class="box-body">
          ...
          <div class="box-footer">
            <div class="form-group">
              <div class="col-sm-offset-1 col-sm-11"> 
                <input type="submit" class="btn btn-primary btn-social btn-submit" style="width: 180px;" name="generar_reporte_leche" value="generar excel">
              </div>
            </div>
          </div>
        </form>
